...
The aim of this _rransi_ pacakage is to provide Resampling RAndom Null distributions 
...
multiplicity correction while accounting for correlations among statistical tests. This will reduce the variability of the false discovery proportion, while increasing the power.

A short tutorial is given here, more detailed instructions can be found in the [Manual]().
