...
Dependence between test statistic is known to render statistical inference more variable. This is caused by the random nature of the null distribution under dependence. The aim of this _rransi_ pacakage is to provide Resampling RAndom Null distributions 
...
```{r approxCor}
rransi:::plotCperm(testVanDePutte$statsPerm)
```
