...
The aim of this pacakage is to provide simultaneous inference for correlated 
hypotheses using collapsed null distributions. These collapsed null distributions 
are estimated through resampling. Wilcoxon rank sum test and two sample t-test
...
Alternatively, the same resamples may be used to determine the marginal null distributions as to estimate the collapsed null distribution, by setting the "permZvals" flag to true.
